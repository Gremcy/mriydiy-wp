                                        ...
                                        <table class="invoice" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; text-align: left; width: 80%; margin: 20px auto;">
                                            ...
                                            <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                                <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 5px 0;" valign="top">
                                                    Тип заявки: <b><?php echo $type['label'] ?: '-'; ?></b><br><br>

                                                    <?php if($type['value'] === 'camp'): ?>
                                                        Табір: <b><?php echo $camp ?: '-'; ?></b><br><br>
                                                    <?php elseif($type['value'] === 'club'): ?>
                                                        Клуб: <b><?php echo $club ?: '-'; ?></b><br><br>
                                                    <?php endif; ?>

                                                    Ім'я: <b><?php echo $name ?: '-'; ?></b><br>
                                                    Телефон: <b><?php echo $phone ?: '-'; ?></b><br>
                                                    E-mail: <b><?php echo $email ?: '-'; ?></b><br>
                                                    Вік дитини: <b><?php echo $age ?: '-'; ?></b><br><br>

                                                    <?php if (in_array($type['value'], ['school', 'kindergarten'])): ?>
                                                        Місто: <b><?php echo $city ?: '-'; ?></b><br><br>
                                                    <?php endif; ?>
